            ...
            >
              ...
              >
                {props.course.courseID
                  ? props.course.courseID
                  : props.course[0].courseID}
                -{props.course.name ? props.course.name : props.course[0].name}
              </Link>
            </Typography>
            {props.user.role === "instructor" ? (
              <Typography className="mb-0">
                {props.course.studentsEnrolled.length} students
              </Typography>
            ) : (
                <Typography className="mb-0">
                  {props.course[0].instructor.name}
                </Typography>
              )}
          </div>
          <div
